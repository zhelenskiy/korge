...
value class DoubleRangeExclusive(val start: Double, val endExclusive: Double) {
...
value class FloatInRange(val value: Float, val min: Float, val max: Float, val inclusive: Boolean = true)

value class FloatRangeExclusive(val start: Float, val endExclusive: Float) {
